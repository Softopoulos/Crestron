...
namespace Softopoulos.Crestron.PhilipsHue
{
	...
	internal struct CIE1931Gamut
	{
		...
		public static readonly CIE1931Gamut PhilipsWideGamut = new CIE1931Gamut(new CIE1931Point(0.700607, 0.299301),
			new CIE1931Point(0.172416, 0.746797), new CIE1931Point(0.135503, 0.039879)
		);
		...
		public static CIE1931Gamut ForModel(string modelId)
		{
			...
			{
				return new CIE1931Gamut(new CIE1931Point(0.704, 0.296), new CIE1931Point(0.2151, 0.7106),
					new CIE1931Point(0.138, 0.08)
				);
			}
			if (gamutB.Contains(modelId))
			{
				return new CIE1931Gamut(new CIE1931Point(0.675, 0.322), new CIE1931Point(0.409, 0.518),
					new CIE1931Point(0.167, 0.04)
				);
			}
			if (gamutC.Contains(modelId))
			{
				return new CIE1931Gamut(new CIE1931Point(0.692, 0.308), new CIE1931Point(0.17, 0.7), new CIE1931Point(0.153, 0.048)
				);
			}
			// A gamut containing all colors (and then some!)
			return new CIE1931Gamut(new CIE1931Point(1.0F, 0.0F), new CIE1931Point(0.0F, 1.0F), new CIE1931Point(0.0F, 0.0F)
			);
		}
